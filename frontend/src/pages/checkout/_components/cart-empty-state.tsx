...
export const CartEmptyState = () => {
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border px-4 py-16 text-center">
      {/* Icon */}
      ...
      <p className="mb-8 max-w-sm leading-relaxed text-gray-600">
        وقتی کالایی را به سبد خرید اضافه کنید جزئیات آن را می‌بینید.
      </p>
